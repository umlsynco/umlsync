...
dm['ds']['diagram'].prototype['_create'] = dm['ds']['diagram'].prototype._create;
dm['ds']['diagram'].prototype['_update'] = dm['ds']['diagram'].prototype._update;
dm['ds']['diagram'].prototype['_init'] = dm['ds']['diagram'].prototype._init;
dm['ds']['diagram'].prototype['Element'] = dm['ds']['diagram'].prototype.Element;
dm['ds']['diagram'].prototype['_setWidgetsOption'] = dm['ds']['diagram'].prototype._setWidgetsOption;
dm['ds']['diagram'].prototype['checkdrop'] = dm['ds']['diagram'].prototype.checkdrop;
dm['ds']['diagram'].prototype['setMenuBuilder'] = dm['ds']['diagram'].prototype.setMenuBuilder;
dm['ds']['diagram'].prototype['removeElement'] = dm['ds']['diagram'].prototype.removeElement;
dm['ds']['diagram'].prototype['removeConnector'] = dm['ds']['diagram'].prototype.removeConnector;
dm['ds']['diagram'].prototype['Connector'] = dm['ds']['diagram'].prototype.Connector;
dm['ds']['diagram'].prototype['_dropConnector'] = dm['ds']['diagram'].prototype._dropConnector;
dm['ds']['diagram'].prototype['_dropSubDiagram'] = dm['ds']['diagram'].prototype._dropSubDiagram;
dm['ds']['diagram'].prototype['_dropElement'] = dm['ds']['diagram'].prototype._dropElement;
dm['ds']['diagram'].prototype['onDragStart'] = dm['ds']['diagram'].prototype.onDragStart;
dm['ds']['diagram'].prototype['onDragMove'] = dm['ds']['diagram'].prototype.onDragMove;
dm['ds']['diagram'].prototype['onDragStop'] = dm['ds']['diagram'].prototype.onDragStop;
dm['ds']['diagram'].prototype['draw'] = dm['ds']['diagram'].prototype.draw;
...
dm['ds']['diagram'].prototype['repeatOperation'] = dm['ds']['diagram'].prototype.repeatOperation;
...
//                }
    ...
    this['parrent']._dropElement(this, {position: {'left':this.start_operation.left + ui.left, 'top':this.start_operation.top + ui.top}}); 
        ...
        //@print
dm['es']['element'] = dm['es']['element'];
dm['es']['element'].prototype['_create'] = dm['es']['element'].prototype._create;
dm['es']['element'].prototype['_update'] = dm['es']['element'].prototype._update;
dm['es']['element'].prototype['_init'] = dm['es']['element'].prototype._init;
dm['es']['element'].prototype['_baseinit'] = dm['es']['element'].prototype._baseinit;
dm['es']['element'].prototype['_setOption'] = dm['es']['element'].prototype._setOption;
dm['es']['element'].prototype['onDragStart'] = dm['es']['element'].prototype.onDragStart;
dm['es']['element'].prototype['onDragMove'] = dm['es']['element'].prototype.onDragMove;
dm['es']['element'].prototype['onDragStop'] = dm['es']['element'].prototype.onDragStop;
...
//                    alert("ELEMENT: " + this['parrent'].elements[i]['euid']);
    ...
    && (p1[1] - 12 < p2[1]) && (p1[1] + 12 > p2[1])) {
        ...
        //@print
dm['cs']['connector'] = dm['cs']['connector'];
dm['cs']['connector'].prototype['addLable'] = dm['cs']['connector'].prototype.addLable;
dm['cs']['connector'].prototype['getDescription'] = dm['cs']['connector'].prototype.getDescription;
dm['cs']['connector'].prototype['_create'] = dm['cs']['connector'].prototype._create;
dm['cs']['connector'].prototype['_init'] = dm['cs']['connector'].prototype._init;
dm['cs']['connector'].prototype['_baseinit'] = dm['cs']['connector'].prototype._baseinit;
dm['cs']['connector'].prototype['drawSelected'] = dm['cs']['connector'].prototype.drawSelected;
dm['cs']['connector'].prototype['draw'] = dm['cs']['connector'].prototype.draw;
dm['cs']['connector'].prototype['redraw'] = dm['cs']['connector'].prototype.redraw;
dm['cs']['connector'].prototype['_getRValue'] = dm['cs']['connector'].prototype._getRValue;
dm['cs']['connector'].prototype['isPointOnLine'] = dm['cs']['connector'].prototype.isPointOnLine;
dm['cs']['connector'].prototype['canRemovePoint'] = dm['cs']['connector'].prototype.canRemovePoint;
dm['cs']['connector'].prototype['startTransform'] = dm['cs']['connector'].prototype.startTransform;
dm['cs']['connector'].prototype['stopTransform'] = dm['cs']['connector'].prototype.stopTransform;
dm['cs']['connector'].prototype['TransformTo'] = dm['cs']['connector'].prototype.TransformTo;
dm['cs']['connector'].prototype['_getConnectionPoints'] = dm['cs']['connector'].prototype._getConnectionPoints;
dm['cs']['connector'].prototype['onDragStart'] = dm['cs']['connector'].prototype.onDragStart;
dm['cs']['connector'].prototype['onDragMove'] = dm['cs']['connector'].prototype.onDragMove;
dm['cs']['connector'].prototype['onDragStop'] = dm['cs']['connector'].prototype.onDragStop;
//@aspect
$.aspect('})(jQuery, dm);');
