...
dm.base.diagram("es.dfentity", dm.es.element, {
    ...
    _create: function() {
      ...
      this.innerHtml = '<div id="' + this.euid + '" style="background-color:yellow;border:1px solid black;width:100%;height:100%;">\
                        <table width=100% height=40px class="ElementResizeArea"><tr><td style="vertical-align:middle;text-align:center;"><a class="editablefield">'+this.options.name+'</a></td></tr></table>\
    </div>';
