        ...
        _create: function() {
            ...
            if (o.scrollable) {
				...
				var $tabs = self.element,
					...
					$navPrev = $('<li class="ui-tabs-arrow-previous ui-state-active" title="Previous"><a href="#"><span class="ui-icon ui-icon-carat-1-w">Previous tab</span></a></li>').prependTo($arrowsNav),
                    $navNext = $('<li class="ui-tabs-arrow-next ui-state-active" title="Next"><a href="#"><span class="ui-icon ui-icon-carat-1-e">Next tab</span></a></li>').appendTo($arrowsNav);
					$.fn.reverse = [].reverse;
